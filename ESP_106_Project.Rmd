...
MidWestUpper$Region <- "MidWestUpper"
MidWestLower$Region <- "MidWestLower"
West_Pacific$Region <- "Pacific Southwest Region"

# Combine all datasets into one
combined_data <- bind_rows(NorthEast, NorthWest_Pacific, SouthEast, South_SouthWest, 
                           Northern_Rockies_Mountain, MidWestUpper, MidWestLower)

# Now pivot the data to wide format
wide_data <- combined_data %>%
  pivot_wider(names_from = Year, values_from = c(YourValueColumnName))  # replace YourValueColumnName with the actual column name
