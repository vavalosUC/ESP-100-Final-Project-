...
slope_fire_amount <- coefficients_fire_amount[2] / 365.25 # Adjust slope to per year
...
```{r}
# Fit a linear model for the acres burned per fire
...
# Calculate the slope per year (adjusting for the slope per day)
slope_per_fire <- coefficients_per_fire["Date"] / 365.25  # Adjust the slope to be per year

# Extract the intercept
intercept_per_fire <- coefficients_per_fire["(Intercept)"]

# Construct the equation of the trend line
# Note: This approach simplifies the date to year conversion for the trend equation's purpose.
equation_per_fire <- paste("Acres Burned per Fire = ", round(intercept_per_fire, digits = 2), "+", round(slope_per_fire, digits = 4), "*(Year - 2000)")
