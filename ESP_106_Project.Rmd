...
MidWest <- merged_data[, c("Date", "Value")]
```
...
long_data <- combined_Region_data %>%
  pivot_longer(cols = -c(Region, Date), names_to = "YourValueColumnName", values_to = "Value")
...
combined_loco.data<- rbind(Temp_loco_32.5N_102.5W, Temp_loco_37.5N_117.5W, Temp_loco_37.5N_102.5W, Temp_loco_42.5N_47.5W, Temp_loco_42.5N_92.5W, Temp_loco_47.5N_117.5W)
